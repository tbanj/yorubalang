...
* */
    private MediaPlayer.OnCompletionListener mmCompletionListener = new MediaPlayer.OnCompletionListener() {
        ...
        public void onCompletion(MediaPlayer mp) {
            Toast.makeText(NumbersActivity.this,R.string.toast_voice_remarks, Toast.LENGTH_SHORT).show();
            releaseMediaPlayer();
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
        //a1-- To use a String it will go with a linear Layout
        ArrayList<String> words = new ArrayList<String>();
         words.add("one");
         words.add("two");
         */

        //a2-- To use a an object class it will go with a ArrayListAdapter and
        //the name of the class have to match e.g we have created word class
       final ArrayList<word> words = new ArrayList<word>();

        //Using ListView and ArrayAdapter an object will be created 1st then it wil be declare
        /** word will be store in the object before the list will be call on
        word w = new word("one","lutti");
        words.add(w);
        */
        //a2--using inline to create a new object and declare it
        words.add(new word("one","ọ̀kan",R.drawable.number_one, R.raw.number_one));
        words.add(new word("two","méjì",R.drawable.number_two, R.raw.number_two));
        words.add(new word("three","mẹ́ta", R.drawable.number_three, R.raw.number_three));
        words.add(new word("four","mẹ́rin", R.drawable.number_four, R.raw.number_four));
        words.add(new word("five","márùn ún", R.drawable.number_five, R.raw.number_five));
        words.add(new word("six","mẹ́fà", R.drawable.number_six, R.raw.number_six));
        words.add(new word("seven","méje", R.drawable.number_seven, R.raw.number_seven));
        words.add(new word("eight","mẹ́jọ", R.drawable.number_eight, R.raw.number_eight));
        words.add(new word("nine","mẹ́sán án", R.drawable.number_nine, R.raw.number_nine));
        words.add(new word("ten","mẹ́wàá", R.drawable.number_ten, R.raw.number_ten));
        ...
        /**
         * @param words is the ArrayList variable name
         * To know where simple_list_item_1.xml is located in your android studio
         *go to
        Project--External Libraries--Android API Platform--res--layout
         */
        ...
        */
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                mMediaPlayer = MediaPlayer.create(NumbersActivity.this, m.getMediaId());
                mMediaPlayer.start();
